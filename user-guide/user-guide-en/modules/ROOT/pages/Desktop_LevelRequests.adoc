...
image:Desktop-LevelRequests-Detailed-PhaseLogs-Example_UsedBuildParameters.png[,325,74] 
|===
...
image:Desktop-LevelRequests-Detailed-PhaseLogs-Example_UsedDeployParameters.png[,325,74] 
|===
...
image:Desktop-LevelRequests-Detailed-Results-expanded.png[,325,248] 
|===
